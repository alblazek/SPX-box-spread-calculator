  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-slate-50 min-h-screen font-sans">
      <div className="bg-white rounded-xl shadow-lg p-8 border border-slate-200">
        ...
        {/* Box Spread Order Example */}
        <div className="mb-8">
          <img src="/3cvs6s0d.png" alt="SPX box spread order example on broker platform" className="w-full rounded-lg shadow-lg border border-slate-200" />
        </div>
